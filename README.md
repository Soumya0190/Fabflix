...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1: HTTP/1 thread                          | /graph_results  | 217                       | 10,302,903 ms                                 | 8,820,764 ms                        | 1 thread took longer than 10 threads           |
...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS MASTER: HTTP/1 thread                          | /graph_results   | 108                         | 7,106,077 ms                                  | 6,573,739 ms                        | Having 1 thread was slower than having 10 threads on the same instance           |
...
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS SLAVE: HTTP/1 thread                          | /graph_results   | 108                       | 110,759,871 ms                                  | 55,569,903 ms                        | Similar to results of master, having 1 thread is slower compared to 10 threads, but is faster than running the single instance           |
| Case 2 AWS SLAVE: HTTP/10 threads                        | /graph_results   | ??                         | 1,143,968 ms                                  | 3,057,154 ms                        | 10 threads results in faster execution time than 1 thread           |
| Case 3 AWS SLAVE: HTTP/10 threads/No connection pooling  | /graph_results   | 117                        |  2,858,440 ms                                | 1,025,506 ms                        | No connection pooling results in slower execution time than having connection pooling           |
**Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
...
| Case 2 GCP MASTER: HTTP/10 threads                        | /graph_results   | 100                         | 4,607,613 ms                                  | 3,551,625 ms                        | 10 threads had faster execution time than single thread           |
| Case 3 GCP MASTER: HTTP/10 threads/No connection pooling  | /graph_results   | 108                       | 2,796,297 ms                                   |  1,955,982 ms                       |           | Without connection pooling and 10 threads, the results were slower than with connection pooling and only 1 thread
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
...
| Case 2 GCP SLAVE: HTTP/10 threads                        | /graph_results   |  105                        | 5561143 ms                                  | 4,412,899 ms                        | With connection pooling and 10 threads, the execution time was the fastest           |
