...
| Case 2: HTTP/10 threads                        | ![](path to image in img/)   | 10 threads were faster than having 1 thread, and connection pooling is faster than no connection pooling                         | 8691160 ms                                  | 6454065 ms                        | ??           |
| Case 3: HTTPS/10 threads                       | ![](path to image in img/)   | 220                         | 9309436 ms                                  | 7879926 ms                        | ??           |
| Case 4: HTTP/10 threads/No connection pooling  | ![](path to image in img/)   | ??                         | 10684810 ms                                  | 8246870                        | As can be seen from times, on the single instance, no connection pooling was slower than having 10 threads with connection pooling           |
 
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS MASTER: HTTP/1 thread                          | ![](path to image in img/)   | 108                         | 1106077 ms                                  | 573739 ms                        | Having 1 threadwas slower than having 10 threads on the same instance           |
| Case 2 AWS MASTER: HTTP/10 threads                        | ![](path to image in img/)   | ??                         | 4025746 ms                                  | 3061537 ms                        | The 10 threads was about 2,000,000 ms faster than having 1 thread on the same instance           |
| Case 3 AWS MASTER: HTTP/10 threads/No connection pooling  | ![](path to image in img/)   | 117                         | 3150529 ms                                   |  2207705 ms                      |      No connection pooling is slower than having 10 threads with connection pooling      |
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS SLAVE: HTTP/1 thread                          | ![](path to image in img/)   | 108                       | 1143968 ms                                  | 569903 ms                        | Similar to results of master, having 1 thread is slower compared to 10 threads, but is faster than running the single instance           |
| Case 2 AWS SLAVE: HTTP/10 threads                        | ![](path to image in img/)   | ??                         | 110759871 ms                                  | 3057154 ms                        | 10 threads results in faster execution time than 1 thread           |
| Case 3 AWS SLAVE: HTTP/10 threads/No connection pooling  | ![](path to image in img/)   | 117                        |  2858440 ms                                | 2025506 ms                        | No connection pooling results in slower execution time than having connection pooling           |
**Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 GCP MASTER: HTTP/1 thread                          | ![](path to image in img/)   | 109                         | 1092474 ms                                  | 576821 ms                        | GCP takes the longest amount of time, and most so with the single thread because there is a netwrok latency           |
| Case 2 GCP MASTER: HTTP/10 threads                        | ![](path to image in img/)   | ??                         | 4607613 ms                                  | 3551625 ms                        | 10 threads had faster execution time than single thread           |
| Case 3 GCP MASTER: HTTP/10 threads/No connection pooling  | ![](path to image in img/)   | 118                       | 2796297 ms                                   |  1955982 ms                       |           | Without connection pooling and 10 threads, the results were slower than with connection pooling and only 1 thread
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 GCP SLAVE: HTTP/1 thread                          | ![](path to image in img/)   | 109                        | 1123661ms                                  | 569278 ms                        |  Similar to results of master, single thread results in more execution time than 10 threads on same instance          |
| Case 2 GCP SLAVE: HTTP/10 threads                        | ![](path to image in img/)   |                          | 5561143 ms                                  | 4412899 ms                        | With connection pooling and 10 threads, the execution time was the fastest           |
| Case 3 GCP SLAVE: HTTP/10 threads/No connection pooling  | ![](path to image in img/)   | 118                       | 2858440 ms                                   |  2025506 ms                    |   Without connection pooling, the results are seen to be slower than with connection pooling         |
