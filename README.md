...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS MASTER: HTTP/1 thread                          | log_processing_apache_master_cp_1.txt          | 108/115 ms                                 | 1,520,610 ms              | 614,266 ms                        | On the AWS Load Balancer, Having 1 thread was slower than having 10 threads on the same instance           |
| Case 2 AWS MASTER: HTTP/10 threads                        | log_processing_apache_master_cp_10.txt         | 109/111 ms                                  | 3,371,767 ms              | 2,524,242 ms                        | The 10 threads was about 2,000,000 ms faster than having 1 thread on the same instance           |
| Case 3 AWS MASTER: HTTP/10 threads/No connection pooling  | log_processing_apache_master_ncp_10.txt        | 272/118/124/272 ms                                 | 5,815,637 ms ms              |  4,552,608 ms                       | No connection pooling is slower than having 10 threads with connection pooling      |
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 AWS SLAVE: HTTP/1 thread                | log_processing_apache_slave_cp_1.txt            | 108/115 ms     | 1,370,663 ms                      | 624,810 ms             | Similar to results of master, having 1 thread is slower compared to 10 threads, but is faster than running the single instance           |
| Case 2 AWS SLAVE: HTTP/10 threads              | log_processing_apache_slave_cp_10.txt           | 109/111      | 3,508,806 ms                        | 2,648,711 ms              | 10 threads results in faster execution time than 1 thread           |
| Case 3 AWS SLAVE: HTTP/10 threads/No connection pooling  | log_processing_apache_slave_ncp_10.txt   | 272/118/124/272 ms   | 5,891,018 ms                       |  4,519,064 ms              | No connection pooling results in slower execution time than having connection pooling           |
**Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1 GCP MASTER: HTTP/1 thread                          | log_processing_gcp_master_cp_1.txt  | 107/108 ms                         | 1,348,639 ms                                   | 607,806 ms                        | GCP takes the longest amount of time, and most so with the single thread because there is a netwrok latency           |
| Case 2 GCP MASTER: HTTP/10 threads                        | log_processing_gcp_master_cp_10.txt    | 100/112 ms                      | 3,662,841 ms                                 | 2,788,663 ms                        | 10 threads had faster execution time than single thread           |
| Case 3 GCP MASTER: HTTP/10 threads/No connection pooling  | log_processing_gcp_master_ncp_10.txt   | 117/112/120 ms                       | 7,151,798,900 ms                                | 4,601,459 ms                       |           | Without connection pooling and 10 threads, the results were slower than with connection pooling and only 1 thread
| **Scaled Version Test Plan**                   | **Graph Results Screenshot** | **Average Query Time(ms)** | **Average Search Servlet Time(ms)** | **Average JDBC Time(ms)** | **Analysis** |
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
...
| Case 3 GCP SLAVE: HTTP/10 threads/No connection pooling  | log_processing_gcp_slave_ncp_10.txt   | 117/112/120 ms     | 6,234,668 ms                        |  4,281,205 ms             |   Without connection pooling, the results are seen to be slower than with connection pooling         |
